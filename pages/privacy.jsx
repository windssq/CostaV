export default function Privacy() {
  ...
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <div className="py-3"></div>
        <p>⊳ Every user can use the CostaV bot however they want, as long as they do not intend to harm.</p>
        <div className="py-3"></div>
        <p>⊳ You cannot use certain commands at the same time while using CostaV.</p>   
        <div className="py-3"></div>
        <p>⊳ CostaV bot does not save any data based on users.</p>
        <div className="py-3"></div>
